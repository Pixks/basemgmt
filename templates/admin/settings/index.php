...
<div style="display:grid;grid-template-columns:1fr 420px;gap:28px;align-items:start;max-width:1180px;">
    ...
    <div class="postbox" style="padding:20px 24px;">
        <h2 class="hndle" style="padding:0 0 10px;">🎨 <?php esc_html_e('Wygląd shortcode panelu kadry', 'basemgmt'); ?> <span style="font-size:.7rem;background:#d63638;color:#fff;padding:2px 8px;border-radius:10px;vertical-align:middle;font-weight:400;">v2.0.6-beta ✓</span></h2>
