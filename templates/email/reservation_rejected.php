 ...
 */
?>
<h2><?php esc_html_e('Rezerwacja odrzucona', 'basemgmt'); ?></h2>
<p><?php esc_html_e('Twoja prośba o rezerwację została odrzucona przez administratora ośrodka.', 'basemgmt'); ?></p>
...
<table class="meta-table">
  ...
  <tr>
    ...
    <td><span class="status-badge status-rejected"><?php esc_html_e('Odrzucona', 'basemgmt'); ?></span></td>
  </tr>
  <?php if ($admin_comment ?? ''): ?>
  <tr><th><?php esc_html_e('Powód:', 'basemgmt'); ?></th><td><?php echo esc_html($admin_comment); ?></td></tr>
  <?php endif; ?>
</table>
<p style="color:#555;font-size:13px;"><?php esc_html_e('W razie pytań skontaktuj się z administratorem ośrodka.', 'basemgmt'); ?></p>
