...
final class ShortcodeHandler {
	...
	private function panel_login( array $atts = [] ): string {
		...
		return $this->wrap_panel(
			esc_html__('Panel kadry', 'basemgmt'),
			'<div class="bm-ui bm-ui--card" x-data="bmLogin()" x-init="init()" x-cloak x-show="!$store.bm.authenticated"' . $redirect_attr . '>'
	...
	private function panel_camp_header(): string {
		return $this->wrap_panel( esc_html__('Przegląd obozu', 'basemgmt'), '<div class="bm-ui bm-ui--card" x-data="bmCamp()" x-init="init()" x-cloak x-show="$store.bm.authenticated">'
			...
			. '</div></div>', '$store.bm.authenticated' );
	}

	private function panel_logout(): string {
		return $this->wrap_panel( esc_html__('Sesja', 'basemgmt'), '<div class="bm-ui bm-ui--inline" x-data="bmLogout()" x-cloak x-show="$store.bm.authenticated">'
			...
			. '</div>', '$store.bm.authenticated' );
	}

	private function panel_announcements(): string {
		return $this->wrap_panel( esc_html__('Aktualności', 'basemgmt'), '<div class="bm-ui bm-ui--card" x-data="bmAnnouncements()" x-cloak x-show="$store.bm.authenticated">'
	...
	private function panel_announcement_form(): string {
		return $this->wrap_panel( esc_html__('Nowe ogłoszenie', 'basemgmt'), '<form class="bm-ui bm-ui--card" x-data="bmAnnForm()" @submit.prevent="submit()" x-cloak x-show="$store.bm.authenticated">'
			...
			. '</div></form>', '$store.bm.authenticated' );
	}

	private function panel_reports(): string {
		return $this->wrap_panel( esc_html__('Meldunek dzienny', 'basemgmt'), '<div class="bm-ui bm-ui--card" x-data="bmReports()" x-init="init()" x-cloak x-show="$store.bm.authenticated">'
	...
	private function panel_weather(): string {
		return $this->wrap_panel( esc_html__('Pogoda', 'basemgmt'), '<div class="bm-ui bm-ui--card" x-data="bmWeather()" x-init="init()" x-cloak x-show="$store.bm.authenticated">'
	...
	private function panel_schedule(): string {
		return $this->wrap_panel( esc_html__('Plan dnia', 'basemgmt'), '<div class="bm-ui bm-ui--card" x-data="bmSchedule()" x-init="init()" x-cloak x-show="$store.bm.authenticated">'
	...
	private function panel_reservations(): string {
		return $this->wrap_panel( esc_html__('Rezerwacje', 'basemgmt'), '<div class="bm-ui bm-ui--card" x-data="bmReservations()" x-init="init()" x-cloak x-show="$store.bm.authenticated">'
	...
	private function panel_menu_day(): string {
		return $this->wrap_panel( esc_html__('Jadłospis', 'basemgmt'), '<div class="bm-ui bm-ui--card" x-data="bmMenu()" x-init="init(); setViewMode(\'day\')" x-cloak x-show="$store.bm.authenticated">'
			...
			. '<p class="bm-ui__error" x-show="error" x-text="error"></p></div></div>', '$store.bm.authenticated' );
	}

	private function panel_menu_week(): string {
		return $this->wrap_panel( esc_html__('Jadłospis', 'basemgmt'), '<div class="bm-ui bm-ui--card" x-data="bmMenu()" x-init="init(); setViewMode(\'week\')" x-cloak x-show="$store.bm.authenticated">'
	...
	private function panel_conversations(): string {
		return $this->wrap_panel( esc_html__('Wiadomości', 'basemgmt'), '<div class="bm-ui bm-ui--card" x-data="bmConversations()" x-init="init()" x-cloak x-show="$store.bm.authenticated">'
	...
	private function panel_conversation_new(): string {
		return $this->wrap_panel( esc_html__('Nowa wiadomość', 'basemgmt'), '<form class="bm-ui bm-ui--card" x-data="bmConversations()" x-init="init(); view=\'new\'" @submit.prevent="createThread()" x-cloak x-show="$store.bm.authenticated">'
			...
			. '<p class="bm-ui__success" x-show="success" x-text="success"></p><p class="bm-ui__error" x-show="error" x-text="error"></p>'
			. '<button class="bm-ui__btn" type="submit" :disabled="loading">' . esc_html__('Wyślij', 'basemgmt') . '</button></div></form>', '$store.bm.authenticated' );
	}

	private function panel_conversation_thread(): string {
		return $this->wrap_panel( esc_html__('Wątek wiadomości', 'basemgmt'), '<div class="bm-ui bm-ui--card" x-data="bmConversations()" x-init="init()" x-cloak x-show="$store.bm.authenticated">'
	...
	private function panel_help_list(): string {
		return $this->wrap_panel( esc_html__('Pomoc', 'basemgmt'), '<div class="bm-ui bm-ui--card" x-data="bmHelp()" x-init="init()" x-cloak x-show="$store.bm.authenticated">'
	...
	private function panel_help_article(): string {
		return $this->wrap_panel( esc_html__('Artykuł pomocy', 'basemgmt'), '<div class="bm-ui bm-ui--card" x-data="bmHelp()" x-init="init()" x-cloak x-show="$store.bm.authenticated">'
	...
	private function panel_forms_list(): string {
		return $this->wrap_panel( esc_html__('Formularze', 'basemgmt'), '<div class="bm-ui bm-ui--card" x-data="bmForms()" x-init="init()" x-cloak x-show="$store.bm.authenticated">'
	...
	private function panel_form(): string {
		return $this->wrap_panel( esc_html__('Wypełnianie formularza', 'basemgmt'), '<div class="bm-ui bm-ui--card" x-data="bmForms()" x-init="init()" x-cloak x-show="$store.bm.authenticated">'
	...
	private function panel_submissions_list(): string {
		return $this->wrap_panel( esc_html__('Moje zgłoszenia', 'basemgmt'), '<div class="bm-ui bm-ui--card" x-data="bmSubmissions()" x-init="init()" x-cloak x-show="$store.bm.authenticated">'
	...
	private function panel_submission(): string {
		return $this->wrap_panel( esc_html__('Szczegóły zgłoszenia', 'basemgmt'), '<div class="bm-ui bm-ui--card" x-data="bmSubmissions()" x-init="init()" x-cloak x-show="$store.bm.authenticated">'
	...
	private function panel_unread_counter(): string {
		return '<div class="bm-ui bm-ui--badge" x-cloak x-show="$store.bm.authenticated"><span x-text="$store.bm.unreadCount"></span></div>';
	}
	...
	private function wrap_panel( string $section_title, string $content, string $visibility = '' ): string {
		...
		return '<div class="bm-ui bm-ui--panel"' . $attrs . '><div class="bm-ui__section-title">' . $section_title . '</div>' . $content . '</div>';
	}
